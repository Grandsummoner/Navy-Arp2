    ...
    : AudioProcessorEditor (&p), processor (p), oledDisplay (p), chromaLookAndFeel (p, this)
{
    ...
    soundButton.setButtonText (juce::String::charToString ((juce::juce_char_t) 0x266B)); // Unicode Music Note "♫"
...
void PluginEditor::paint (juce::Graphics& g)
{
    ...
    if (isLeftPanelOpen)
    {
        ...
        std::vector<HelpSection> sections = {
            { "01 // SYSTEM MIDI ROUTING", juce::Colour (0xFF00E5FF), 65 },  // Teal
            { "02 // VOICE 1 (SCENE A TARGET)", juce::Colour (0xFFFF3366), 185 },  // Pink
            { "03 // VOICE 2 (SCENE B TARGET)", juce::Colour (0xFFD500F9), 385 },  // Purple
            { "04 // SYNTH AUDIO ROUTING", juce::Colour (0xFFFFB300), 585 }   // Gold
        };
...
void PluginEditor::resized()
{
    ...
    soundButton.setBounds (15, 15, 18, 18); // Symmetrical note anchor always at top-left edge of entire window
...
void PluginEditor::timerCallback()
{
    ...
    // Force repaint of visual layers
    repaint();
    oledDisplay.repaint();
}
